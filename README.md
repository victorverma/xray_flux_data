...
To download the raw 1-minute data to [`data/raw/1m/`](data/raw/1m/), source [`scripts/download_1m_data.R`](scripts/download_1m_data.R):

```r
source("scripts/download_1m_data.R")
```

To create a Parquet file containing all of the data and save it to [`data/processed/`](data/processed/), source [`scripts/process_1m_data.R`](scripts/process_1m_data.R):
